...
function distro(){
  ...
  // add Jumbotron
  document.getElementById("distroFoundJumbotron").innerHTML += '<div class="alert alert-success " id="text" ><div class="alert  text-center"><h1 class="heading">Distros found!</h1><p class="lead">All distros found are ordered descending from peak similarity</p><a class="text-center btn btn-lg btn-danger btn-responsive" href="index.html">Start Over</a></div></div>';
  ...
  for (j = 0; j < SelectedDistros.length; j++){
    ...
    '<div class="card mx-auto my-3 text-center" style="width: 22rem;">'+
      ...
      '<div class="card-body">'+
        ...
        '<a href='+current.link+' class="btn btn-success btn-space" target="_blank">Website</a>'+
      '</div>'+
    '</div>';
  }
